import { raw, type SafeHtml } from './html';
...
const PATHS = {
  ...
  pencil: '<path d="M21.2 5.8a2.8 2.8 0 0 0-4-4L3.8 15.2a2 2 0 0 0-.5.9l-1.3 4.4a.5.5 0 0 0 .6.6l4.4-1.3a2 2 0 0 0 .9-.5z"/><path d="m15 5 4 4"/>',
...
export const icon = (name: IconName, cls = ''): SafeHtml =>
  raw(
    `<svg class="icon ${cls}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${PATHS[name]}</svg>`,
  );

/** The app mark (same drawing as public/icon.svg). */
export const logoMark = raw(
  '<svg class="logo-mark" viewBox="0 0 64 64" aria-hidden="true"><rect width="64" height="64" rx="14" fill="#256abf"/><path d="M15 13a3 3 0 0 1 3-3h28a3 3 0 0 1 3 3v40l-5.67-3.5-5.67 3.5-5.66-3.5-5.67 3.5-5.66-3.5L15 53z" fill="#fff"/><path d="M37.91 22.13A6.82 5.58 0 1 0 32 30.5A6.82 5.58 0 1 1 26.09 38.87" fill="none" stroke="#256abf" stroke-width="6.2" stroke-linecap="round"/></svg>',
);

export const googleLogo = raw(
...
export const microsoftLogo = raw(
